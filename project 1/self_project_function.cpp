...
// View Jobs Function
void viewJobs(string total_jobs[]){
    system("cls");
    cout<<"Available Jobs : \n";
    for(int i=0; i<5; i++){
...
void searchJobs(string total_jobs[]){
    system("cls");
    cout<<"Search Jobs : \n";
...
// ================= FREELANCER LOGIN FUNCTION =================

void freelancerLogin(
    string freelancerUsernameArr[],
    string freelancerPasswordArr[],
    string roleArr[],
    int yearsArr[],
    int index,
    string total_jobs[]
...
int main(){
    ...
    while(true){
        ...
        if(userOption==1){
            ...
            freelancerLogin(
                freelancerUsernameArr,
                freelancerPasswordArr,
                roleArr,
                yearsArr,
                index,
                total_jobs
